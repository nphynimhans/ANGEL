function [ALLEEG, EEG, CURRENTSET, returnFile, errorReturn] =  NPhy_HandleEvents(ALLEEG, EEG, CURRENTSET, ANGEL, inputFile)
%NPhy_HandleEvents Import events and adjust sound marker latencies for EGI
%   
...
if strcmp(ANGEL.acquisitionID, 'EGI')
    ...
    try
        ...
        if ~exist(eventFile, 'file')
           [eventFile, error] = NPhy_ImportEventsFromNetStation(EEG, ANGEL, inputFile);
...
fprintf(ANGEL.logFileID,'\nCompleted event handling for : %s \n',inputFile);
